...
<body class="d-flex">
    ...
    <div class="d-flex flex-column flex-shrink-0 p-3 text-bg-dark" style="width: 280px; min-height: 100vh;">
        ...
        <ul class="nav nav-pills flex-column mb-auto">
            <li class="nav-item">
                <a href="<?php echo base_url('index.php/data_motor'); ?>" class="nav-link text-white <?php echo ($active_page == 'datamotor') ? 'active' : ''; ?>">Data Motor</a>
            </li>
            <li class="nav-item">
    ...
    <!-- Application/views/data_motor.php -->
    <div class="container mt-3">
        <h2>Data Motor</h2>
        <a href="<?php echo base_url('index.php/DataMotor/tambah'); ?>" class="btn btn-tambah mb-3">Tambah Data Motor</a>
        <!-- Table to display motor data -->
        <table class="table">
            <thead>
                <tr>
                    <th>Gambar</th> <!-- Foto disesuaikan menjadi Gambar -->
                    <th>Plat Motor</th>
                    <th>Merk & Tipe</th>
                    <th>Harga Sewa</th>
                    <th>Status</th>
            ...
            <tbody>
                <?php foreach ($data_motor as $motor) : ?>
                    <tr>
                    <td><img src="<?php echo base_url('assets/') . $motor->Gambar; ?>" alt="<?php echo $motor->Gambar; ?>" width="150"></td>
                        <td><?php echo $motor->PlatMotor; ?></td>
                        <td><?php echo $motor->Merk_Tipe; ?></td>
                        <td><?php echo $motor->HargaSewa; ?></td>
                        <td><?php echo $motor->Status; ?></td>
                        <td>
                        <a href="<?php echo base_url('index.php/data_motor/edit/' . $motor->PlatMotor); ?>" class="btn btn1 btn-sm">Edit</a>
                        <a href="<?php echo base_url('index.php/data_motor/delete/' . str_replace(' ', '_', $motor->PlatMotor)); ?>" class="btn btn2 btn-sm" onclick="return confirm('Apakah Anda yakin ingin menghapus motor ini?')">Hapus</a>
                    </tr>
                <?php endforeach; ?>
            </tbody>
        </table>
