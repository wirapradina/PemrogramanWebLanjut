...
<body class="d-flex">
    ...
    <div class="d-flex flex-column flex-shrink-0 p-3 text-bg-dark" style="width: 280px; min-height: 100vh;">
        ...
        <ul class="nav nav-pills flex-column mb-auto">
            ...
            <li class="nav-item">
                <a href="<?php echo base_url('index.php/customer'); ?>" class="nav-link text-white <?php echo ($active_page == 'customer') ? 'active' : ''; ?>">Customer</a>
            </li>
        </ul>
        <hr>
        <div class="dropdown">
    ...
    <!-- application/views/customer.php Content -->
    <div class="container mt-3">
        <h2>Data Customer</h2>
        <a href="<?php echo base_url('index.php/customer/tambah'); ?>" class="btn btn-tambah mb-3">Tambah Data Customer</a>
        ...
        <table class="table">
            <thead>
                <tr>
                    ...
                    <th>Nama</th>
                    <th>Nomor Telepon</th>
                    <th>Alamat</th> <!-- New column for address -->
